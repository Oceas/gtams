<?php 
  ...
  if(strcmp($file_ext, 'pdf') == 0 ){
     ...
     if(move_uploaded_file($fileTemp, $file_destination)){
       $sql = "UPDATE applicants SET responded=true, letter_pdf='".$file_destination."' WHERE pid='".$pid."' AND semester_session_id='".$sessionId."';";
    }       
  } else {
     $letterText = $_POST["advisementLetterTyped"];
     $sql = "UPDATE applicants SET responded=true, letter='".$letterText."' WHERE pid='".$pid."' AND semester_session_id='".$sessionId."';";
